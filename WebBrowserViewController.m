...
- (void)loadView
{
    ...
    // The following for-loop will replace the last 6 lines
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    ...
    NSString *stringADD = [URLString stringByReplacingCharactersInRange:spaceRange withString:@"+"];
    
    // if space exists
    if (spaceRange.location) {
    ...
    if (!URL.scheme && !spaceRange.location) {
